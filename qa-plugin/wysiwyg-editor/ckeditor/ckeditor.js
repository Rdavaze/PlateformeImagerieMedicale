...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        b.prototype = {
            getListenerIndex: function(a) {
                for (var e = 0, d = this.listeners; e < d.length; e++)
                    if (d[e].fn == a) return e;
                return -1
            }
        };
        return {
            ...
            fire: function() {
                ...
                return function(k, j, g) {
                    ...
                    if (m) {
                        var s = m.listeners;
                        if (s.length)
                            for (var s = s.slice(0), w, q = 0; q < s.length; q++) {
                                if (m.errorProof) try {
                                    w =
                                        s[q].call(this, g, j, e, b)
                                } catch (t) {} else w = s[q].call(this, g, j, e, b);
        ...
        CKEDITOR.tools = {
            ...
            extend: function(a) {
                var e = arguments.length,
                    d, b;
                if (typeof(d = arguments[e - 1]) == "boolean") e--;
                else if (typeof(d = arguments[e - 2]) == "boolean") {
                    b = arguments[e - 1];
                    e = e - 2
                }
                for (var c = 1; c < e; c++) {
            ...
            buildStyleHtml: function(a) {
                for (var a = [].concat(a), e, d = [], b = 0; b < a.length; b++)
                    if (e = a[b]) /@import|[{}]/.test(e) ? d.push("<style>" + e + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + e + '">');
                return d.join("")
            },
            ...
            normalizeCssText: function(a, e) {
                var d = [],
                    b, c = CKEDITOR.tools.parseCssText(a, true, e);
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
            ...
            var b = this.$.cloneNode(a),
                c = function(e) {
                    ...
                    if (e.nodeType == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (a)
                            for (var e = e.childNodes, d = 0; d < e.length; d++) c(e[d])
                    }
                };
            c(b);
        ...
        getPosition: function(a) {
            ...
            for (var f = this.getAddress(), a = a.getAddress(),
                    b = Math.min(f.length, a.length), c = 0; c <= b - 1; c++)
                if (f[c] != a[c]) {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], j = 0; j < c.length; j++)
                        if (f)
                            for (var g = 0; g < f.length; g++) b.push([a, c[j], f[g]].join("-"));
            ...
            getDocumentPosition: function(a) {
                var b = 0,
                    ...
                    f = this.getDocument(),
                    j = f.getBody(),
                    g = CKEDITOR.env.quirks;
                if (document.documentElement.getBoundingClientRect) {
                    var m = this.$.getBoundingClientRect(),
                        y = f.$.documentElement,
                        s = y.clientTop || j.$.clientTop || 0,
                        w = y.clientLeft || j.$.clientLeft || 0,
                        q = true;
                    if (CKEDITOR.env.ie) {
            ...
            find: function(b) {
                var c = a(this),
                    b = new CKEDITOR.dom.nodeList(this.$.querySelectorAll(f(this, b)));
                c();
                return b
            },
            findOne: function(b) {
                var c = a(this),
                    b = this.$.querySelector(f(this, b));
                c();
    ...
    (function() {
        function a(a, b) {
            ...
            if (this.current) d = this.current[p](false, l, h);
            else {
                if (a) d.type ==
                    CKEDITOR.NODE_ELEMENT && (d = f > 0 ? d.getChild(f - 1) : h(d, true) === false ? null : d.getPreviousSourceNode(true, l, h));
                else {
                    d = e;
    ...
    (function() {
            ...
            e = function(a, b, c, d) {
                ...
                if (e.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (i >= e.getChildCount()) {
                        ...
                        h = true
                    } else e = e.getChild(i).getPrevious();
                else {
                ...
                for (c = l; c < A.length; c++) {
                    ...
                    if (!i[c] || g.$.parentNode != i[c].$.parentNode)
                        for (g = g.getPrevious(); g;) {
                            if (g.equals(i[c]) || g.equals(e)) break;
                            j = g.getPrevious();
                            if (b == 2) n.$.insertBefore(g.$.cloneNode(true), n.$.firstChild);
                            else {
                                g.remove();
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function() {
                function a(c) {
                    ...
                    if (d.type == CKEDITOR.NODE_TEXT) {
                        f = d;
                        for (m = 0;
                            (f = f.getPrevious()) && f.type == CKEDITOR.NODE_TEXT;) m = m + f.getLength();
                        f = m;
                        if (d.getText()) e = e + f;
                        else {
                            m = d.getPrevious(b);
            ...
            getBoundaryNodes: function() {
                ...
                if (b.type == CKEDITOR.NODE_ELEMENT) {
                    e = b.getChildCount();
                    if (e > d) b = b.getChild(d).getPreviousSourceNode(true);
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                            ...
                            for (; l;) {
                                ...
                                if (l.type == CKEDITOR.NODE_COMMENT) l = l.getPrevious();
                                    ...
                                    if (l.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        d.test(j) && (l = null);
                                        n = /[\s\ufeff]$/.test(j)
                                    } else if ((l.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && l.is("br")) && !l.data("cke-bookmark"))
                                        if (r && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                            j = l.getText();
                                            if (d.test(j)) l = null;
                                            else
                                                for (var C = l.$.getElementsByTagName("*"), k = 0, F; F = C[k++];)
                        ...
                        if (n.type == CKEDITOR.NODE_TEXT)
                            if (CKEDITOR.tools.trim(n.substring(C)).length) r = true;
                            else {
                                r = !n.getLength();
                                if (C == n.getLength()) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var I, v, G = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                                br: 1
                            } : null),
                            z = null,
                            B = function(a) {
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    if (e && e.type == CKEDITOR.NODE_TEXT)
                        if (i)
                            if (i >= e.getLength()) d.setStartAfter(e);
                            else {
                                d.setStartBefore(e);
                                g = 0
                            }
            ...
            moveToClosestEditablePosition: function(a, b) {
                var c = new CKEDITOR.dom.range(this.root),
                    d = 0,
                    e, f = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
    ...
    (function() {
        ...
        function b(a, c, d, e) {
            ...
            if ((h = CKEDITOR.filter.instances[e.element.data("cke-filter")]) &&
                !h.check(c)) return b(a, c, d, e.remaining);c = new CKEDITOR.dom.range(e.element);c.selectNodeContents(e.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = h;a._.nestedEditable = {
                element: e.element,
                container: d,
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    h = t.startPath();
                    var i = t.endPath(),
                        A = !t.collapsed && c(t, h.block),
                        u = !t.collapsed && c(t, i.block, 1);
                ...
                for (this._.nextNode = null; i;) {
                    var A = 0,
                        u = i.hasAscendant("pre"),
                        o = i.type != CKEDITOR.NODE_ELEMENT,
                        l = 0;
                    if (o) i.type == CKEDITOR.NODE_TEXT && e.test(i.getText()) &&
                        ...
                        if (CKEDITOR.dtd.$block[p] && i.getAttribute("contenteditable") == "false") {
                            ...
                            b(this, a, f);
                            break
                        } else if (i.isBlockBoundary(this.forceBrBreak && !u && {
                                br: 1
                            })) {
                            if (p == "br") o = 1;
                            else if (!h && !i.getChildCount() && p != "hr") {
                                f = i;
                                s = i.equals(t);
                                break
                            }
                ...
                if (!f) {
                    ...
                    f = f.block;
                    if (!f && i && !this.enforceRealBlocks && A[i.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !i.equals(h.root)) f = i;
                    else if (!f || this.enforceRealBlocks && f.is(j)) {
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (f in b) {
                p = b[f];
                p = typeof p == "boolean" ? {} : typeof p == "function" ? {
                    match: p
                } : K(p);
            ...
            for (var b = e.elements, e = e.generic, C, c = 0, d = a.length; c < d; ++c) {
                ...
                if (f.elements === true || f.elements === null) e[p ? "unshift" : "push"](f);
                else {
                    i = f.elements;
                    delete f.elements;
                    for (C in i)
                        if (b[C]) b[C][p ? "unshift" : "push"](f);
                        else b[C] = [f]
                }
            }
        }
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = false, f = a === true, p = b.length; p--;)
                        if (f || a(b[p])) {
                            b.splice(p, 1);
                            d =
                                true
        ...
        function w(a, b, d, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a: for (var x = a.elementCallbacks, h = 0, n = x.length, v; h < n; ++h)
                    if (v = x[h](b)) {
                        r = v;
                        break a
                    }if (r) return r
            ...
            if (e.doFilter) {
                a: {
                    x = b.name;
                    h = a._;a = h.allowedRules.elements[x];r = h.allowedRules.generic;x = h.disallowedRules.elements[x];h = h.disallowedRules.generic;n = e.skipRequired;v = {
                        valid: false,
                        validAttributes: {},
                        validClasses: {},
                        validStyles: {},
                ...
                z = a.validAttributes;
                var E = a.validStyles;r = a.validClasses;
                var x = b.attributes,
                    A = b.styles,
                    h = b.classes,
                    n = b.classBackup,
                    o = b.styleBackup,
                    g, B, C = [];v = [];
                var j = /^data-cke-/;q = false;delete x.style;delete x["class"];delete b.classBackup;delete b.styleBackup;
                if (!a.allAttributes)
                    for (g in x)
                        if (!z[g])
                            if (j.test(g)) {
        ...
        function l(a, b, c) {
            var d = a.name;
            if (L.$empty[d] || !a.children.length)
                if (d == "hr" && b == "br") a.replaceWith(u());
                else {
                    a.parent && c.push({
                        check: "it",
                        el: a.parent
        ...
        function r(a, b) {
            ...
            for (f in d)
                if (f == "class") {
                    c = d[f].split(/\s+/);
                    for (i = a.classes.join("|"); l = c.pop();)
                        if (i.indexOf(l) == -1) return false
                } else if (a.attributes[f] != d[f]) return false;
            for (p in e)
                if (a.styles[p] != e[p]) return false;
            return true
        }
                        ...
                        a: {
                            ...
                            if (p)
                                for (l = 0; l < p.length; ++l)
                                    if ((n = d.match(p[l])) && n[0].length == d.length) {
                                        c = true;
                                        break a
                                    }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);d.children.length == 1 && (i = d.children[0]).type == CKEDITOR.NODE_ELEMENT && w(e, i, c, h);c = !c.length
                        }
                        c || f.push(a)
                    }
                }, null, true);
                        ...
                        w = function(b) {
                            if (a[b]) y(b, true);
                                ...
                                if (!(d.length >
                                    ...
                                    if (c)
                                        if (CKEDITOR.env.ie && CKEDITOR.env.version < 11) e.$.onreadystatechange = function() {
        ...
        load: function(a, f, b) {
            ...
            CKEDITOR.scriptLoader.load(d, function(a, d) {
                ...
                for (var e = 0; e < a.length; e++)
                    for (var q = h[a[e]], g = 0; g < q.length; g++) {
                        var i = q[g];
                        k[i] = this.get(i);
                        c[i] = 1
                    }
                ...
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (m in a) {
                            ...
                            if (!f[m]) {
                                if (k.icons)
                                    for (var w = k.icons.split(","), q = w.length; q--;) CKEDITOR.skin.addIcon(w[q], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + w[q] + ".png");
                                f[m] = 1
                            }
                            if (s) {
                                s.split && (s = s.split(","));
    ...
    (function() {
        ...
        function m(a) {
            ...
            if (d) var f = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
                c = c.replace(f, ""),
                c = c + ("," + d);
            if (e) var l = RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
                c = c.replace(l, "");
            CKEDITOR.env.air &&
                (c = c + ",adobeair");
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var i in c) {
                    ...
                    if (A && (v = A.match(l)))
                        for (; A = v.pop();) CKEDITOR.tools.setTimeout(function(a, b) {
                    ...
                    if (g && !a.lang[i]) {
                        ...
                        if (!h.langEntries || !h.langEntries[o]) f.push(CKEDITOR.getUrl(h.path + "lang/" + o + ".js"));
                        else {
    ...
    (function() {
                    ...
                    if (a(e)) i.push(e);
                        ...
                        if (d == "br") A.push(e);
                            ...
                            for (;;) {
                                ...
                                if (!e.isUnknown && !u.isUnknown && !m[d])
                                    if (u.isOptionalClose) q.onTagClose(h);
                                    else if (d in b && h in b) {
                                    h = u.children;
                                    (h = h[h.length - 1]) && h.name == "li" || y(h = new CKEDITOR.htmlParser.element("li"), u);
                                    !e.returnPoint && (e.returnPoint = u);
                                    u = h
                                } else if (d in CKEDITOR.dtd.$listItem && !w(d, h)) q.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1);
                                else if (h in f && !w(d, h)) {
                                    !e.returnPoint && (e.returnPoint = u);
                                    u = u.parent
                                } else {
                                    h in CKEDITOR.dtd.$inline && i.unshift(u);
                                    if (u.parent) y(u, u.parent, 1);
                                    else {
                                        e.isOrphan = 1;
                                        break
                                    }
        ...
        CKEDITOR.htmlParser.fragment.prototype = {
            ...
            forEach: function(a, b, c) {
                ...
                if (e !== false)
                    for (var c = this.children, f = 0; f < c.length; f++) {
                        e = c[f];
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                onElement: function(a, c) {
                    for (var e = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], d, f = 0; f < 3; f++)
                        if (d = e[f]) {
                            d = d.exec(a, c, this);
                ...
                return function(f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var i = [],
                            ...
                            x, r;
                        if (l)
                            for (v(l, 1) && i.push(l); l;) {
                                if (d(l) && (x = c(l)) && v(x))
                                    if ((r = c(x)) && !d(r)) i.push(x);
                                    else {
                                        p(g).insertAfter(x);
                                        x.remove()
                                    }
                        ...
                        if (i = !a || (typeof e == "function" ? e(f) : e) !== false)
                            if (!g && !CKEDITOR.env.needsBrFiller &&
                                f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) i = false;
                            else if (!g && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem)) i = false;
                        else {
                            i = b(f);
    ...
    (function() {
        ...
        CKEDITOR.inlineAll = function() {
            ...
            for (b in CKEDITOR.dtd.$editable)
                for (var c = CKEDITOR.document.getElementsByTag(b), e = 0, d = c.count(); e < d; e++) {
                    a = c.getItem(e);
                    if (a.getAttribute("contenteditable") == "true") {
                        f = {
                            element: a,
    ...
    (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    if (f)
                        for (;
                            (r = b.getCommonAncestor(0, 1)) && (n = CKEDITOR.dtd[r.getName()]) && (!n || !n[e]);)
                            if (r.getName() in
        ...
        var m = CKEDITOR.dom.walker.bogus(),
            ...
            w = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var q = function() {
                ...
                var r = CKEDITOR.dtd,
                    ...
                    C = CKEDITOR.tools.extend({}, r.$inline);
                delete C.br;
                return function(g, n, k) {
                    var q = g.editor,
                        v = q.getSelection().getRanges()[0],
                        G = false;
                    ...
                    if (!v.checkReadOnly()) {
                        ...
                        if (!q.collapsed) {
                            var z = E.block || E.blockLimit,
                                w = q.getCommonAncestor();
                            z && (!z.equals(w) && !z.contains(w) && q.checkEndOfBlock()) && n.zombies.push(z);
                            q.deleteContents()
                        }
                        for (;
                            (s = a(q.startContainer) && q.startContainer.getChild(q.startOffset - 1)) && a(s) && s.isBlockBoundary() && x.contains(s);) q.moveToPosition(s, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (D = E.isLineBreak) {
                                    ...
                                    if (E.hasBlockSibling) D = 1;
                                        ...
                                        if (!O || !O.is({
                                            ...
                                            V = O.getPosition(M);
                                            if (V == CKEDITOR.POSITION_IDENTICAL || V == CKEDITOR.POSITION_CONTAINS) D = 0;
                                            else {
                                                M = D.splitElement(O);
                        ...
                        if (S)
                            for (; H = S.pop();) CKEDITOR.env.needsBrFiller ? H.appendBogus() : H.append(J.document.createText(" "));
    ...
    (function() {
        ...
        var w, q, t = CKEDITOR.dom.walker.invisible(1),
            i = function() {
                function a(b) {
                    return function(a) {
        ...
        var A = typeof window.getSelection != "function",
            u = 1;
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = A ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        return {
                            container: x,
                            offset: j > 0 ? -h : x.nodeValue.length + h
                        }
                    };
                    return function() {
                        var a = this.getNative(),
            ...
            getSelectedText: function() {
                ...
                var b = this.getNative(),
                    b = A ? b.type == "Control" ? "" : b.createRange().text : b.toString();
    ...
    (function() {
            ...
            if (b.collapsed) {
                ...
                for (n.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(o)) {
                        ...
                        if (s && m && CKEDITOR.dtd.$block[r])
                            for (var y = n, u = c(y), A = void 0, C = u.length, F = 0, y = C && new CKEDITOR.dom.range(y.getDocument()); F < C; ++F) {
                                var A = u[F],
                                    P = CKEDITOR.filter.instances[A.data("cke-filter")];
                                if (P ? P.check(this) : 1) {
                        ...
                        if (u)
                            if ((u = n.getParent()) && ((u.getDtd() || CKEDITOR.dtd.span)[e] || h) && (!g.parentRule || g.parentRule(u))) {
                                ...
                                if (r == CKEDITOR.NODE_TEXT || s || r == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                                    for (var r = n, U;
                                        (j = !r.getNext(L)) && (U = r.getParent(), k[U.getName()]) && (U.getPosition(q) | I) == I && (!g.childRule || g.childRule(U));) r = U;
                                    p.setEndAfter(r)
                                }
                            } else j = true;
                        else j = true;
                    ...
                    if (j && p && !p.collapsed) {
                        for (var j = i(this, d), s = j.hasAttributes(), t = p.getCommonAncestor(), r = {}, u = {}, A = {}, C = {}, N, R, X; j && t;) {
                            if (t.getName() == e) {
                                ...
                                for (R in g.styles)
                                    if (!A[R] && (X = t.getStyle(R))) j.getStyle(R) == X ? r[R] = 1 : A[R] = 1
                            }
                            t = t.getParent()
                        }
        ...
        function s(a, b) {
            var c = this._.definition,
                ...
                g;
            for (g in d)
                if (!((g == "class" || this._.definition.fullMatch) && a.getAttribute(g) != l(g, d[g])) && !(b && g.slice(0, 5) == "data-")) {
                    f = a.hasAttribute(g);
                    a.removeAttribute(g)
                }
            for (var h in c)
    ...
    CKEDITOR.dom.elementPath.prototype = {
        compare: function(a) {
            ...
            for (var b = 0; b < f.length; b++)
                if (!f[b].equals(a[b])) return false;
            return true
        },
    ...
    (function() {
        function a(a, c, e) {
            var d = a.serializable,
                f = c[e ? "endContainer" : "startContainer"],
                k = e ? "endOffset" : "startOffset",
            ...
            createIterator: function() {
                ...
                return {
                    getNextRange: function(f) {
                        ...
                        if (k && a.length > 1) {
                            if (!d)
                                for (var j = a.length - 1; j >= 0; j--) e.unshift(a[j].createBookmark(true));
                            if (f)
                                for (var g = 0; a[d + g + 1];) {
    ...
    */
    ...
    (function() {
        ...
        function J(a) {
            ...
            f ? f.show() : (g = ['<div tabIndex="-1" style="position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", g, "; top: 0px; left: 0px; ", !CKEDITOR.env.ie6Compat ?
                    "background-color: " + e : "", '" class="cke_dialog_background_cover">'
    ...
    (function() {
        function E(b, k, e) {
            function d(d) {
                if ((a = c[d ? "getFirst" : "getLast"]()) && (!a.is || !a.isBlockBoundary()) && (m = k.root[d ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) && (!m.is || !m.isBlockBoundary({
                        br: 1
                    }))) b.document.createElement("br")[d ? "insertBefore" : "insertAfter"](a)
            }
        ...
        function y(b, k, e) {
            ...
            var f = k.createBookmark(),
                ...
                c = h.contains(CKEDITOR.dtd.$listItem),
            ...
            arrayToList: function(b, k, e, d, f) {
                ...
                for (var g, i = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(i), c = null, a = e, m = Math.max(b[e].indent, 0), j = null, n, l, p = d == CKEDITOR.ENTER_P ? "p" : "div";;) {
                    ...
                    if (o.indent == m) {
                        ...
                        j.append(a.listNode), a = a.nextIndex;
                        ...
                        var c = g.getDirection(1) != n,
                            u = o.element,
                            z = u.getAttribute("class"),
                            v = u.getAttribute("style"),
                            w = j.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (d != CKEDITOR.ENTER_BR || c || v || z),
                            s, x = o.contents.length,
                            t;
                        for (g = 0; g < x; g++)
                            if (s = o.contents[g], D(s) && 1 < x) w ? t = s.clone(1, 1) : j.append(s.clone(1, 1));
        ...
        x.prototype = {
            exec: function(b) {
                ...
                for (var k = e.createBookmarks(!0), f = [], i = {}, d = d.createIterator(), h = 0;
                    (g = d.getNextRange()) && ++h;) {
                    var c = g.getBoundaryNodes(),
                        a = c.startNode,
                        m = c.endNode;
                    ...
                    g = g.createIterator();
                    for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; c = g.getNextParagraph();)
                        if (!c.getCustomData("list_block")) {
                            CKEDITOR.dom.element.setMarker(i, c, "list_block", 1);
                            for (var j = b.elementPath(c), a = j.elements, m = 0, j = j.blockLimit, n, l = a.length - 1; 0 <= l && (n = a[l]); l--)
                ...
                for (n = []; 0 < f.length;)
                    if (a = f.shift(), this.state == CKEDITOR.TRISTATE_OFF)
                        if (r[a.root.getName()]) {
                            ...
                            j = [];
                            for (c = 0; c < h.contents.length; c++)
                                if (l = h.contents[c], (l = l.getAscendant("li", !0)) && !l.getCustomData("list_item_processed")) j.push(l), CKEDITOR.dom.element.setMarker(a, l, "list_item_processed", !0);
                            for (var l = h.root.getDocument(), p = void 0, o = void 0, c = 0; c < j.length; c++) {
                                var u = j[c].getCustomData("listarray_index"),
                                    p = m[u].parent;
    ...
    (function() {
        function k(a) {
            ...
            } catch (g) {}(CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == e.document.$.compatMode) && this.attachListener(this, "keydown", function(a) {
                var b = a.data.getKeystroke();
                if (b == 33 || b == 34)
    ...
    CKEDITOR.config.plugins = 'basicstyles,blockquote,dialogui,dialog,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,menu,contextmenu,entities,popup,filebrowser,listblock,richcombo,font,format,horizontalrule,image,indent,indentlist,justify,fakeobjects,link,list,liststyle,magicline,maximize,pastefromword,removeformat,resize,specialchar,tab,table,tabletools,toolbar,undo,wysiwygarea,smiley';
